...
const MessageTextCircle2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <rect width={40} height={40} rx={20} fill='url(#paint0_linear_449_328)' />
    <path
    ...
    />
    <defs>
      <linearGradient id='paint0_linear_449_328' x1={20} y1={0} x2={40} y2={36.5} gradientUnits='userSpaceOnUse'>
